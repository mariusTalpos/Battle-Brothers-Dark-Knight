...
::Const.Strings.PerkDescription.DarkKnightAbyssalDrain <- "Drain the smoldering embers of life from your slain enemies.\n\n[color=#4f1800][u]Passive:[/u][/color]\n• Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5[/color] hitpoints.\n\n[color=#4f1800][u]Active:[/u][/color]\n• Unlocks the \'Abyssal Drain\' active skill which allows you to destroy a corpse on the battlefield, healing yourself scaling with resolve.";
